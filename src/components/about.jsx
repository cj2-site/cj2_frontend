...
const About = () => {
  return (
    <>
      <div>
        <section>
          <img src={jori} alt="Jori image" title="Jori image" />
          ...
          <button><a href="https://www.linkedin.com/in/joriefernandez/" target="_blank">LinkedIn</a></button>
          <button><a href="https://github.com/joriefernandez" target="_blank">Github</a></button>
        </section>
      </div>
      <div>
        <section>
          <img src={john} alt="John image" title="John image" />
          <h2>John Winters</h2>
      ...
      <div>
        <section>
          <img src={charles} alt="Charles image" title="Charles image" />
          ...
          <button><a href="https://www.linkedin.com/in/cclemensjr/" target="_blank">LinkedIn</a></button>
        </section>
      </div>
      <div>
        <section>
          <img src={stephen} alt="Stephen image" title="Stephen image" />
          <h2>Stephen Chu</h2>
          <p>SDE Apprentice | BSc Applied Math | US Air Force Veteran</p>
          <button><a href="https://www.linkedin.com/in/stephenchu530/" target="_blank">LinkedIn</a></button>
        </section>
      </div>
    </>
  );
